                                  ...
                                  <div class="media">
                                    <div class="media-left">
                                      <div class="media-object">
                                        <img src="https://api.adorable.io/avatars/71/42.png" class="img-circle" alt="50x50" style="width: 50px; height: 50px;">
                                      </div>
                                    </div>
                                    <div class="media-body">
                                      <strong class="notification-title">{{$message->author}}</strong>
                                      <!--p class="notification-desc">Extra description can go here</p-->
                                      <div class="notification-meta">
                                        <small class="timestamp">{{$message->content}}</small>
                                      </div>
                                    </div>
                                  </div>
                              </li>
...
<script type="text/javascript">
    ...
    var socket = io.connect('http://noti.todo.com:6001')
        console.log(socket);
        socket.on('laravel_database_noti:message',function(data){
           console.log(data)
        ...
        var newNotificationHtml = `
          <li class="notification active">
              <div class="media">
                ...
                <div class="media-body">
                  <strong class="notification-title">`+data.author+`</strong>
                  <!--p class="notification-desc">Extra description can go here</p-->
                  <div class="notification-meta">
                    <small class="timestamp">`+data.content+`</small>
                  </div>
                </div>
              </div>
          </li>
